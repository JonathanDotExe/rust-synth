...
For VST2, copy VST/RustDemoPlugin.vst under
...
For VST3, copy VST3/RustDemoPlugin.vst3 under
  - $HOME/Library/Audio/Plug-ins/VST3 for a single user
  - or /Library/Audio/Plug-ins/VST3 for all users (may require admin access)
  - or any DAW specific path (64bits)

For Audio Unit, copy Components/RustDemoPlugin.component under $HOME/Library/Audio/Plug-ins/Components
